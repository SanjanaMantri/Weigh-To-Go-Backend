...
public class routes {
  ...
  public static final controllers.ReverseFoodIntakeController FoodIntakeController = new controllers.ReverseFoodIntakeController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseFoodIntakeController FoodIntakeController = new controllers.javascript.ReverseFoodIntakeController(RoutesPrefix.byNamePrefix());
  }
